...
const counterItems = [
  ...
  { ind: 2, value: 1.5, suffix: "+", label: "Years in Competitive Programming" },
  { ind: 3, value: 15, suffix: "+", label: "Total Projects" },
  { ind: 4, value: 7, suffix: "+", label: "Deployed Projects" },
  { ind: 5, value: 500, suffix: "+", label: "Solved DSA and CP Problems on various platforms" },
];
...
const expCards = [
  ...
  },
  {
    ...
    imgPath: "/images/logos/nextIcon.png",
  ...
  {
    review: "Diving into competitive programming and data structures sharpened my problem-solving skills and taught me how to write efficient, optimized code under constraints. It’s a discipline that pushed me to think critically and approach problems systematically.",
    imgPath: "/images/logos/codeforces.png", // or leetcode.png / cp-logo.png
    logoPath: "/images/logo3.png", // update this based on your design
    title: "Competitive Programmer & DSA Enthusiast",
    date: "March 2024 - Present",
    responsibilities: [
      "Solved 800+ problems across platforms like Codeforces, LeetCode, and AtCoder.",
      "Mastered core data structures like arrays, linked lists, trees, heaps, and graphs.",
      "Implemented advanced algorithms including dynamic programming, greedy algorithms, and graph traversal.",
      "Regularly participated in contests to improve speed, accuracy, and ranking.",
      "Built strong foundations in time and space complexity analysis to write optimal code.",
      "Maintained a consistent GitHub repository of solved problems for revision and sharing.",
    ],
  }
...
const projects = [
  ...
  {
    title: "AI Interview Assistant with AI voice Agent",
    image: "/images/ai_interview.png",
    liveLink: "https://ai-interview-assistant-dusky.vercel.app/",
